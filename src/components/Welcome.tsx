    ...
    <div className="bg-white dark:bg-gray-800 ">
      <div className="text-center w-full mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 z-20">
        <h2 className="text-4xl font-extrabold text-black dark:text-white sm:text-6xl">
          ...
          <span className="block text-3xl text-indigo-500 sm:text-4xl">
            Built with Tailwind-Kit
          </span>
        </h2>
        <p className="text-xl mt-4 max-w-md mx-auto text-gray-400">
          Create dynamic, performant apps quickly with the power of Next.js +
          TailwindCSS combined with Emotion for CSS-in-JS styling.
        </p>
